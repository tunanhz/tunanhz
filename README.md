<!--
====================================================================
  GITHUB PROFILE README — Duong Tuan Anh (@tunanhz)
  Deploy: repo tunanhz/tunanhz (Public) -> README.md at root of main
  Images: dark-bg / transparent only (blend with dark theme).
    - assets/coder-dark.gif        (About Me, dark navy coder)
    - assets/tech-stack-animation.gif (Tech Stack, dark bg)
    - assets/divider.svg           (animated divider)
    - output branch: github-snake*.svg (snake, transparent)
  Removed on request: GitHub Analytics (summary cards), 3D calendar,
    white-bg gifs, streak/trophy/github-readme-stats (were broken).
====================================================================
-->
...
|---------|-------------|------|
| 🎉 **[Event Management](https://github.com/tunanhz/Event_Management)** | Full-stack event management platform | `TypeScript` |
